...
![alt text](/images/Scarlet_CTF_2026/ruid_login_file.png)

- Use `checksec` to verify that the binary has an executable stack.
![alt text](/images/Scarlet_CTF_2026/ruid_login_checksec.png)
...
![alt text](/images/Scarlet_CTF_2026/ruid_login_callrax.png)
![alt text](/images/Scarlet_CTF_2026/ruid_login_plt.png)
